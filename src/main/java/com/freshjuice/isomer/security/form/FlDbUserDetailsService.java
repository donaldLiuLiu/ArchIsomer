...
@Slf4j
public class FlDbUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        try {
            FlDbUserDetails details = new FlDbUserDetails();
            ...
            List<FlDbPermission> permissions = rs.stream().map(r -> FlDbPermission.builder().permission(r.getCode()).build()).collect(Collectors.toList());
